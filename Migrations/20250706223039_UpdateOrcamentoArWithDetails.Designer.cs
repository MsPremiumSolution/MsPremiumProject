...
namespace MSPremiumProject.Migrations
{
    ...
    [Migration("20250706223039_UpdateOrcamentoArWithDetails")]
    partial class UpdateOrcamentoArWithDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSPremiumProject.Models.Higrometria", b =>
                {
                    ...
                    b.Property<decimal?>("DataLoggerSensores")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("MSPremiumProject.Models.Medida", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned");
            ...
            modelBuilder.Entity("MSPremiumProject.Models.OrcamentoAr", b =>
                {
                    ...
                    b.Property<string>("FiltroManutencao")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<bool>("HasAcessoriosExtras")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("HasAdaptacaoSistema")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("HasControleTecnico")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("HasExecucaoProjeto")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("HasInstalacaoMaoDeObra")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("HasVigilancia24h")
                        .HasColumnType("tinyint(1)");

                    b.Property<decimal>("M3VolumeHabitavel")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<int>("NumeroCompartimentos")
                        .HasColumnType("int");

                    b.Property<int>("NumeroPisos")
                        .HasColumnType("int");

                    b.Property<decimal>("ValorConfiguracaoFabricacao")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("ValorFabricacao")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("ValorImplementacaoTrabalho")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("ValorManutencao")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("ValorPersonalizacao")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("MSPremiumProject.Models.DadosGerais", b =>
                {
                    ...
                    b.HasOne("MSPremiumProject.Models.Tipojanela", null)
                        .WithMany("Dadosgerals")
                        .HasForeignKey("TipoJanelaId");
