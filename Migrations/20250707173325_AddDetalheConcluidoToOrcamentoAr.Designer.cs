...
namespace MSPremiumProject.Migrations
{
    ...
    [Migration("20250707173325_AddDetalheConcluidoToOrcamentoAr")]
    partial class AddDetalheConcluidoToOrcamentoAr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSPremiumProject.Models.OrcamentoAr", b =>
                {
                    ...
                    b.Property<bool>("DetalheConcluido")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("ResumoConcluido")
                        .HasColumnType("tinyint(1)");

                    b.Property<decimal>("TaxaIva")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("TotalFinalComIva")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("ValorIva")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("ValorTotalDetalhe")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("MSPremiumProject.Models.OrcamentoArLinha", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned");
            ...
            modelBuilder.Entity("MSPremiumProject.Models.OrcamentoArLinha", b =>
                {
                    b.HasOne("MSPremiumProject.Models.OrcamentoAr", "OrcamentoAr")
                        .WithMany("LinhasOrcamento")
                        .HasForeignKey("OrcamentoArId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
